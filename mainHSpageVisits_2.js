...
// Versuch mit Promise.all() - läuft!!!
    var aktuelleHS = await Promise.all([nameHS, empfQuote, anzBewertungen, anzSeitenAufrufe])
    // .map((facts) => {
    //     var hsObj = {
    //       name: nameHS,
    //       quote: empfQuote,
    //       anzBewert: anzBewertungen,
    //       anzHits: anzSeitenAufrufe
    //     }
    //   });
    //console.log(aktuelleHS);
    let hsDaten = new HSMain(...aktuelleHS);
    console.log(hsDaten);
